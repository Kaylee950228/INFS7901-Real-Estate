...
<div class="row">
  <div class="main">
        ...
        <thead>
            ...
            <?php
                // FILL TABLE WITH DATA ON CLICK
                  $sql = "SELECT Apartment_units.*, Real_estate_company.name FROM Apartment_units INNER JOIN Real_estate_company ON Apartment_units.company_ID = Real_estate_company.company_ID AND( Apartment_units.company_ID=\"1001\" OR Apartment_units.company_ID=\"4001\" OR Apartment_units.company_ID=\"6001\")";
   ...
   <p>AND (Apartment_units.company_ID="1001"</p>
   <p>OR Apartment_units.company_ID="4001"</p>
   <p>OR Apartment_units.company_ID="6001")</p>
  </div>
</div>
