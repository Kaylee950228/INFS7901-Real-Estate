...
<div class="row">
  <div class="main">
    ...
    ?>
    <h2>Finding apartments which is available before 2018.05.14</h2>
    <table table border="1" style="font-size:16px;font-family:serif;" cellpadding="7">
        <thead>
            <tr>
            ...
            <?php
                // FILL TABLE WITH DATA ON CLICK
                  $sql = "SELECT * FROM Apartment_units WHERE (Apartment_units.company_ID, Apartment_units.unit_name)
                    IN (SELECT Apartment_units.company_ID, Apartment_units.unit_name 
                    From Apartment_units 
                    JOIN C_available ON C_available.company_ID = Apartment_units.company_ID 
                    AND C_available.unit_name=Apartment_units.unit_name 
                    WHERE C_available.available_date<20180514)";
   ...
   <br>
   <h3>SQL code</h3>
   <p>SELECT * FROM Apartment_units</p>
   <p>WHERE (Apartment.company_ID,Apartment.unit_name)</p>
   <p>IN (SELECT</p> 
   <p>Apartment_units.company_ID,Apartment_units.unit_name</p>
   <p>From Apartment_units JOIN C_available</p>
   <p>ON C_available.company_ID=Apartment_units.company_ID</p>
   <p>AND C_available.unit_name=Apartment_units.unit_name 
   <p>WHERE C_available.available_date < 20180514)</p>
