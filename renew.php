...
<div class="row">
  <div class="main">
    ...
    ?>
    <table table border="1" style="font-size:9px;font-family:serif;" cellpadding="10">
        <thead>
            <tr>
            ...
            <?php
                // FILL TABLE WITH DATA ON CLICK
                  $sql = "SELECT Apartment_units.*, L_available.contract_status,L_available.available_date,Renew.renewal_date FROM (Apartment_units INNER JOIN L_available ON Apartment_units.unit_name = L_available.unit_name) RIGHT JOIN Renew ON L_available.lease_ID = Renew.lease_ID";
                  ...
                  while ($rows = mysqli_fetch_array($result)) {
                        ...
                        echo "<td>".$rows["renewal_date"]."</td>";
                        echo "</tr>";
                    }
                            ?>
       
    </table>
    <p>SELECT Apartment_units.*, L_available.contract_status,L_available.available_date,Renew.renewal_date</p>
    <p>FROM (Apartment_units INNER JOIN L_available ON Apartment_units.unit_name = L_available.unit_name)</p>
    <p>RIGHT JOIN Renew ON L_available.lease_ID = Renew.lease_ID</p>
  </div>
</div>
