...
<div class="row">
  <div class="main">
    ...
    ?>
    <h2>MAB</h2>
    <table ctable border="1" style="font-size:15px;font-family:serif;" cellpadding="8">
        <thead>
            <tr>
            ...
            <?php
                // FILL TABLE WITH DATA ON CLICK
                  $sql = "SELECT Apartment_units.*, Real_estate_company.name FROM Apartment_units INNER JOIN Real_estate_company ON Apartment_units.company_ID = Real_estate_company.company_ID AND Apartment_units.company_ID=\"3003\"";
   ...
   <p>AND (Apartment_units.company_ID="3003"</p>
